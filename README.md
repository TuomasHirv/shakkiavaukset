...
I dont use built-in id and changing it is very difficult so i chose to not change it

The line that is too long is sql code. It is much more readable when the whole SELECT statement is on one line
